...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote:
      "Kerja remote mah wajib internet cepet. idPlay ngebantu banget, meeting lancar, upload file juga tinggal duduk manis.",
    author: "Ayu",
    role: "Freelancer",
  },
  {
    quote:
      "Pernah tengah malam koneksi agak ngadat, chat CS, eh langsung dibantu. Pelayanannya emang gak kaleng-kaleng",
    author: "Mira",
